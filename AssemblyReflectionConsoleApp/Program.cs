...
namespace AssemblyReflectionConsoleApp
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            var fullName = mathAdvancedAssembly.FullName; // the fully qualified name Math.Advanced, Version=2.0.0.0, Culture=neutral, PublicKeyToken=9a6e2ec23b9a60ea
            var assemblyName = mathAdvancedAssembly.GetName(); // The fully qualified as AssemblyName object.
            ...
            var cultureInfo = assemblyName.CultureInfo; // empty if not a satellite assembly.
